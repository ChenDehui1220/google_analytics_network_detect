...
var scripts = {
    ...
    pageview: {
        ...
        page: [
            ...
            { name: '(Mobile)首頁', url: '?m=1', isMobile: true },
            { name: '(Mobile)館首', url: 'index/shopindex?shopid=15&m1', isMobile: true },
            { name: '(Mobile)中分頁首', url: 'index/midindex?shopid=15&midid=63&t=2&m=1', isMobile: true }
        ]
    }
